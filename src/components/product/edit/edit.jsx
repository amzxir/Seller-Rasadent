        ...
        <form className={styles.editProduct} onSubmit={handleSubmit(onSubmit)}>
          <div className={styles.pad}>
            ...
            <div className={styles.formGroup}>
              ...
              <input type="text" className="formControl" {...register("nameFa")}  defaultValue={dataManage.nameFa} />
              <FontAwesomeIcon icon={faFileSignature} />
            </div>
            <div className={styles.formGroup}>
            <label className={styles.nameLabel}>{t('labelNameEn')}</label>
            <span className={styles.error}>{errors.nameEn?.message}</span>
            <input type="text" className="formControl" {...register("nameEn")} defaultValue={dataManage.nameEn}/>
            <FontAwesomeIcon icon={faFileSignature} />
            </div>
            <div className={styles.formGroup}>
            ...
            <div className={styles.formGroup}>
              ...
              <input type="text" className="formControl" {...register("stock")} defaultValue={dataManage.stock}/>
